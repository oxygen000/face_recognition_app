...
const MenuItems: React.FC<MenuItemsProps> = ({ role, onLogout, onCloseMenu }) => {
  const { t } = useTranslation();
  return (
    <div className="py-2">
      <Link
...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    <div
      className="absolute right-0 mt-2 w-56 sm:w-full sm:right-auto sm:left-0 bg-white border border-gray-200 rounded-md shadow-lg z-50 animate-fade-in"
    >
